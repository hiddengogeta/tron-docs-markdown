...
TronWidgets is a collection of libraries that allow you to interact with the ecosystem of the TRON network. It aims to provide some out-of-the-box JavaScript SDKs and UI components (coming soon) for TRON developers. At present, a @tronwidgets/transaction lib is provided, which is a wrap of [TronWeb](https://tron.network/) transaction builder lib. More libraries are on the way.

The following documentation will guide you through installing and using @tronwidgets/transaction to create transactions on the TRON network.

# What is transaction

This lib can help DApp developers trigger contract transactions, query contract methods, etc. With transaction, DApp developers will be able to:

* build, sign, and broadcast transactions
* use the call or view method to query the specific parameters of contracts
* deploy contracts
* send TRX or other tokens
...
[Tronwallet Adapter](/docs/tronwallet-adapter)[Smart Contract Development](/docs/smart-contract-development)