...
# [#](#winklink-anyapi-service) WINkLink AnyAPI Service
...
![anyapi-flow.png](/v2/doc/assets/img/anyapi-flow.09dbb954.png)
...
## [#](#how-to-use-existing-winklink-anyapi) How to use existing WINkLink AnyAPI
...
### [#](#anyapi-request-process) AnyAPI Request Process
...
## [#](#how-to-setup-anyapi-contracts-and-jobs) How to setup AnyAPI contracts and jobs

### [#](#winkmid-contract) WinkMid Contract
...
Testnet Faucet: [https://nileex.io/join/getJoinPage  (opens new window)](https://nileex.io/join/getJoinPage)
...
### [#](#operator-contract-2) Operator Contract
...
### [#](#single-word-request) Single word request
...
### [#](#multi-word-request) Multi word request
...
| tvm call | Perform call to contracts on tvm chain | []byte | Contract call [`Return`  (opens new window)](https://github.com/tron-oracle/winklink-2.0/blob/develop/core/chains/tvm/tron-sdk/proto/api/api.pb.go#L214-L222) struct |
