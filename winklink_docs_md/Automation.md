...
# [#](#winklink-automation-service) WINkLink Automation Service
...
![automation-flow.png](/v2/doc/assets/img/automation-flow.3beeb98f.png)
...
## [#](#how-to-use-existing-winklink-automation) How to use existing WINkLink Automation
...
### [#](#automation-registration-process) Automation Registration Process
...
### [#](#automation-execution-process) Automation execution Process
...
## [#](#how-to-setup-automation-contracts-and-jobs) How to setup Automation contracts and jobs
...
### [#](#registry-and-registrar-contract) Registry and Registrar Contract
...
### [#](#upkeep-contract) Upkeep Contract
...
### [#](#custom-logic-upkeep) Custom logic upkeep
