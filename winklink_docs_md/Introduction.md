...
# [#](#introduction-to-winklink) Introduction to WINkLink
...
## [#](#what-is-winklink) What is WINkLink

WINkLink is a decentralized oracle project that operates on the TRON network. For more information about the TRON Network and its development basics, please visit [TRON Developer Hub  (opens new window)](https://developers.tron.network).
...
## [#](#how-winklink-works) How WINkLink Works
...
### [#](#tron-blockchain) TRON blockchain
...
## [#](#winklink-request-model) WINkLink Request Model
...
## [#](#winklink-off-chain-reporting-model) WINkLink Off-Chain Reporting Model
...
## [#](#join-the-winklink-ecosystem) Join the WINkLink Ecosystem

Welcome to the WINkLink ecosystem! Collaborate with WINkLink to create a trusted on-chain data network.

**Community Channels:**

* Telegram: [Join channel  (opens new window)](https://t.me/WINkLink_Oracle_official)
* GitHub Project: [GitHub - wink-link/winklink  (opens new window)](https://github.com/wink-link/winklink)

**How to Participate:**

Whether you are a data consumer, data provider, or node operator, you can contribute to the WINkLink ecosystem.

* Become a Data Consumer — Trusted Price Feeds for DeFi Security  
   👉 [Apply Here  (opens new window)](https://docs.google.com/forms/d/e/1FAIpQLSd-YWewuQcKDTEeL-IitHFUEAy6mXaRj_yLic2vtXi8FhFaVw/viewform)
* Become a Data Provider — Unlock Value for Trusted Data Sources  
   👉 [Apply Here  (opens new window)](https://docs.google.com/forms/d/e/1FAIpQLScasXYrYtSG9VC9LK_QUEbXPL76jSVZd26dy-Z4T5IV76h2Kg/viewform)
* Run a WINkLink Node — Join the node network to enhance the ecosystem’s security and decentralization.  
   👉 [View Node Deployment Guide  (opens new window)](https://doc.winklink.org/v2/doc/node.html)