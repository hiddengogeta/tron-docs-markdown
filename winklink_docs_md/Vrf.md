...
# [#](#winklink-verifiable-random-number-service) WINkLink Verifiable Random Number Service
...
### [#](#direct-funding-flow) Direct Funding flow

![vrf-direct-funding-flow.png](/v2/doc/assets/img/vrf-direct-funding-flow.c5967464.png)

### [#](#subscription-flow) Subscription flow

![vrf-subscription-flow.png](/v2/doc/assets/img/vrf-subscription-flow.0e207f09.png)

### [#](#tron-nile-vrf-contracts) Tron Nile VRF Contracts
...
### [#](#tron-mainnet-vrf-contracts) Tron Mainnet VRF Contracts
...
## [#](#how-to-use-existing-winklink-verifiable-random-number-service) How to use existing WINkLink Verifiable Random Number Service

### [#](#vrf-request-process) VRF Request Process
...
### [#](#vrfcoordinatorv2-contract) VRFCoordinatorV2 Contract
...
### [#](#vrfv2wrapper-contract) VRFV2Wrapper Contract
...
### [#](#authorize-a-node-account) Authorize a Node Account
...
### [#](#dapp-contract-sample) Dapp Contract Sample
...
## [#](#how-to-setup-verifiable-random-function-contracts) How to setup Verifiable Random Function Contracts
...
### [#](#add-a-vrf-job-to-your-node) Add a VRF Job to Your Node
