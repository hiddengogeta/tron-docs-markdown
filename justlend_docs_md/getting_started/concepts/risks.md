...
### **Smart Contract Risk**[¶](#smart-contract-risk "Permanent link")
...
#### Mitigation Measures:[¶](#mitigation-measures "Permanent link")
...
### **Oracle Risk**[¶](#oracle-risk "Permanent link")
...
#### Mitigation Measures:[¶](#mitigation-measures_1 "Permanent link")
...
### **Collateral Risk**[¶](#collateral-risk "Permanent link")
...
#### Mitigation Measures:[¶](#mitigation-measures_2 "Permanent link")
...
### **Risk Alert**[¶](#risk-alert "Permanent link")

#### Why can't I receive email notifications?[¶](#why-cant-i-receive-email-notifications "Permanent link")
...
1. **Mailbox Settings**
2. Junk folder: Check the junk folder in your mailbox. Sometimes, email notifications can be mistakenly classified as junk emails. If you find the target notification in the junk folder, move it to your inbox or add the sender to your “Contacts”.
3. Email filters: Verify if your email service provider has set filters that have blocked or filtered out the email notifications. It is important to make sure the sender’s address is added to your whitelist or allowlist.
4. **Email Sending Issues**
5. Sending delays: Sometimes, email notifications may not come through quickly due to the delay issues. Please be patient and check your inbox again later.
6. Sending failures: If your emails cannot be sent or are rejected, you may also experience difficulty in receiving email notifications. In this case, you can check your outbox about this kind of issue and try again in the JustLend platform.
7. **User Information**
8. Incorrect email address: Make sure you have provided a correct email address in the “Risk Alert” service on JustLend DAO and have verified that your address functions well.
