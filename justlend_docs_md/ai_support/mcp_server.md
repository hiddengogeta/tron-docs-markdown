...
## Quick Setup[¶](#quick-setup "Permanent link")
...
### Wallet Setup (First-Use Choice)[¶](#wallet-setup-first-use-choice "Permanent link")
...
#### CLI (agent-wallet)[¶](#cli-agent-wallet "Permanent link")
...
#### MCP Tools (runtime)[¶](#mcp-tools-runtime "Permanent link")
...
### Tools (59 total)[¶](#tools-59-total "Permanent link")

#### Wallet & Network[¶](#wallet-network "Permanent link")
...
#### Market Data[¶](#market-data "Permanent link")
...
#### Account & Balances[¶](#account-balances "Permanent link")
...
#### Lending Operations[¶](#lending-operations "Permanent link")
...
#### Mining & Rewards[¶](#mining-rewards "Permanent link")
...
#### JST Voting / Governance[¶](#jst-voting-governance "Permanent link")
...
#### sTRX Staking[¶](#strx-staking "Permanent link")
...
#### Transfers[¶](#transfers "Permanent link")
...
### Prompts (AI-Guided Workflows)[¶](#prompts-ai-guided-workflows "Permanent link")
