...
# multiSign [<src>](https://github.com/tronprotocol/tronweb/blob/v6.3.0/src/lib/trx.ts#L732)
...
Object - The signed transaction, see the example below.

## Example[​](#example "Direct link to Example")

```
const tradeobj = await tronWeb.transactionBuilder.freezeBalance(tronWeb.toSun(100), 3, "ENERGY", "415d73f56d93a9380a100d2a340dd30dc3df6e0746", "415d73f56d93a9380a100d2a340dd30dc3df6e0746");  
const signedtxn = await tronWeb.trx.multiSign(tradeobj, privateKey, 2);  
