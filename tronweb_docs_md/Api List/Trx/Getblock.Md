...
# getBlock [<src>](https://github.com/tronprotocol/tronweb/blob/v6.3.0/src/lib/trx.ts#L87)
...
| --- | --- | --- |
| blockNumberOrBlockId | The height of the Block or blockId or `'latest'` or `'earliest'` | Integer |

## Return[​](#return "Direct link to Return")

Object - The block information, see examples below.

## Example[​](#example "Direct link to Example")

```
//Example 1  
await tronWeb.trx.getBlock(12345);  
{  
...
//Example 2  
await tronWeb.trx.getBlock('000000000000303987c7c8ab3f5967c107a619fa47819940597e9938811a1764');  
{  
  blockID: '000000000000303987c7c8ab3f5967c107a619fa47819940597e9938811a1764',  
  block_header: {  
    raw_data: {  
