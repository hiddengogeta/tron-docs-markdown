...
# listExchanges [<src>](https://github.com/tronprotocol/tronweb/blob/v6.3.0/src/lib/trx.ts#L1254)
...
Array - The list of all the exchange pairs.

## Example[​](#example "Direct link to Example")

```
await tronWeb.trx.listExchanges();  
[  
  {  
    exchange_id: 169,  
