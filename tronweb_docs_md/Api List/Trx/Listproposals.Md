...
# listProposals [<src>](https://github.com/tronprotocol/tronweb/blob/v6.3.0/src/lib/trx.ts#L1054)
...
Object Array - The list of the proposals.

## Example[​](#example "Direct link to Example")

```
await tronWeb.trx.listProposals();  
[  
  {  
    proposal_id: 28,  
