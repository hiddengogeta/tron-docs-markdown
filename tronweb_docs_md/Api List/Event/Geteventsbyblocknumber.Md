...
# getEventsByBlockNumber() [<src>](https://github.com/tronprotocol/tronweb/blob/v6.3.0/src/lib/event.ts#L126)

Query events by block number.

## Usage[​](#usage "Direct link to Usage")

```
const events = await tronWeb.event.getEventsByBlockNumber(  
    blockNumber,  
    options  
  );
```
...
| --- | --- | --- |
| blockNumber | number of block | String |
