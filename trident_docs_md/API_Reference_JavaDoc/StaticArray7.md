...
## Class StaticArray7<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray7<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray7<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray7(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray7(java.lang.Class<T> type, T... values)` |
    | `StaticArray7(java.util.List<T> values)` Deprecated. |
    | `StaticArray7(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray7
      ...
      ```
      @Deprecated
      public StaticArray7(java.util.List<T> values)
      ```
    ...
    - #### StaticArray7
      ...
      ```
      public StaticArray7(java.lang.Class<T> type,
