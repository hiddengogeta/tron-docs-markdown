...
## Class StaticArray6<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray6<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray6<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray6(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray6(java.lang.Class<T> type, T... values)` |
    | `StaticArray6(java.util.List<T> values)` Deprecated. |
    | `StaticArray6(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray6
      ...
      ```
      @Deprecated
      public StaticArray6(java.util.List<T> values)
      ```
    ...
    - #### StaticArray6
      ...
      ```
      public StaticArray6(java.lang.Class<T> type,
