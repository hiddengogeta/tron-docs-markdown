...
## Class StaticArray9<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray9<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray9<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray9(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray9(java.lang.Class<T> type, T... values)` |
    | `StaticArray9(java.util.List<T> values)` Deprecated. |
    | `StaticArray9(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray9
      ...
      ```
      @Deprecated
      public StaticArray9(java.util.List<T> values)
      ```
    ...
    - #### StaticArray9
      ...
      ```
      public StaticArray9(java.lang.Class<T> type,
