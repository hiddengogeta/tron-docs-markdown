...
## Class StaticArray8<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray8<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray8<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray8(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray8(java.lang.Class<T> type, T... values)` |
    | `StaticArray8(java.util.List<T> values)` Deprecated. |
    | `StaticArray8(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray8
      ...
      ```
      @Deprecated
      public StaticArray8(java.util.List<T> values)
      ```
    ...
    - #### StaticArray8
      ...
      ```
      public StaticArray8(java.lang.Class<T> type,
