...
## Class StaticArray28<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray28<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray28<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray28(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray28(java.lang.Class<T> type, T... values)` |
    | `StaticArray28(java.util.List<T> values)` Deprecated. |
    | `StaticArray28(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray28
      ...
      ```
      @Deprecated
      public StaticArray28(java.util.List<T> values)
      ```
    ...
    - #### StaticArray28
      ...
      ```
      public StaticArray28(java.lang.Class<T> type,
