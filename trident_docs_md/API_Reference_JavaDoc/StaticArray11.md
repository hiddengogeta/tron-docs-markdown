...
## Class StaticArray11<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray11<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray11<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray11(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray11(java.lang.Class<T> type, T... values)` |
    | `StaticArray11(java.util.List<T> values)` Deprecated. |
    | `StaticArray11(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray11
      ...
      ```
      @Deprecated
      public StaticArray11(java.util.List<T> values)
      ```
    ...
    - #### StaticArray11
      ...
      ```
      public StaticArray11(java.lang.Class<T> type,
