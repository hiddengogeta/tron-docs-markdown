...
## Class StaticArray23<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray23<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray23<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray23(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray23(java.lang.Class<T> type, T... values)` |
    | `StaticArray23(java.util.List<T> values)` Deprecated. |
    | `StaticArray23(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray23
      ...
      ```
      @Deprecated
      public StaticArray23(java.util.List<T> values)
      ```
    ...
    - #### StaticArray23
      ...
      ```
      public StaticArray23(java.lang.Class<T> type,
