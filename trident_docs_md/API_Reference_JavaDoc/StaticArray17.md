...
## Class StaticArray17<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray17<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray17<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray17(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray17(java.lang.Class<T> type, T... values)` |
    | `StaticArray17(java.util.List<T> values)` Deprecated. |
    | `StaticArray17(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray17
      ...
      ```
      @Deprecated
      public StaticArray17(java.util.List<T> values)
      ```
    ...
    - #### StaticArray17
      ...
      ```
      public StaticArray17(java.lang.Class<T> type,
