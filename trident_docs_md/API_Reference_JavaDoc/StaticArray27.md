...
## Class StaticArray27<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray27<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray27<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray27(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray27(java.lang.Class<T> type, T... values)` |
    | `StaticArray27(java.util.List<T> values)` Deprecated. |
    | `StaticArray27(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray27
      ...
      ```
      @Deprecated
      public StaticArray27(java.util.List<T> values)
      ```
    ...
    - #### StaticArray27
      ...
      ```
      public StaticArray27(java.lang.Class<T> type,
