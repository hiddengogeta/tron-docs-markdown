...
## Class StaticArray1<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray1<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray1<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray1(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray1(java.lang.Class<T> type, T... values)` |
    | `StaticArray1(java.util.List<T> values)` Deprecated. |
    | `StaticArray1(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray1
      ...
      ```
      @Deprecated
      public StaticArray1(java.util.List<T> values)
      ```
    ...
    - #### StaticArray1
      ...
      ```
      public StaticArray1(java.lang.Class<T> type,
