...
## Class StaticArray16<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray16<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray16<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray16(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray16(java.lang.Class<T> type, T... values)` |
    | `StaticArray16(java.util.List<T> values)` Deprecated. |
    | `StaticArray16(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray16
      ...
      ```
      @Deprecated
      public StaticArray16(java.util.List<T> values)
      ```
    ...
    - #### StaticArray16
      ...
      ```
      public StaticArray16(java.lang.Class<T> type,
