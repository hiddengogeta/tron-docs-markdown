...
## Class StaticArray12<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray12<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray12<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray12(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray12(java.lang.Class<T> type, T... values)` |
    | `StaticArray12(java.util.List<T> values)` Deprecated. |
    | `StaticArray12(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray12
      ...
      ```
      @Deprecated
      public StaticArray12(java.util.List<T> values)
      ```
    ...
    - #### StaticArray12
      ...
      ```
      public StaticArray12(java.lang.Class<T> type,
