...
## Class StaticArray30<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray30<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray30<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray30(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray30(java.lang.Class<T> type, T... values)` |
    | `StaticArray30(java.util.List<T> values)` Deprecated. |
    | `StaticArray30(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray30
      ...
      ```
      @Deprecated
      public StaticArray30(java.util.List<T> values)
      ```
    ...
    - #### StaticArray30
      ...
      ```
      public StaticArray30(java.lang.Class<T> type,
