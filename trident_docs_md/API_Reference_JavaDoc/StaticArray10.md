...
## Class StaticArray10<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray10<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray10<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray10(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray10(java.lang.Class<T> type, T... values)` |
    | `StaticArray10(java.util.List<T> values)` Deprecated. |
    | `StaticArray10(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray10
      ...
      ```
      @Deprecated
      public StaticArray10(java.util.List<T> values)
      ```
    ...
    - #### StaticArray10
      ...
      ```
      public StaticArray10(java.lang.Class<T> type,
