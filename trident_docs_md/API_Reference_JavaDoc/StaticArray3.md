...
## Class StaticArray3<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray3<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray3<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray3(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray3(java.lang.Class<T> type, T... values)` |
    | `StaticArray3(java.util.List<T> values)` Deprecated. |
    | `StaticArray3(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray3
      ...
      ```
      @Deprecated
      public StaticArray3(java.util.List<T> values)
      ```
    ...
    - #### StaticArray3
      ...
      ```
      public StaticArray3(java.lang.Class<T> type,
