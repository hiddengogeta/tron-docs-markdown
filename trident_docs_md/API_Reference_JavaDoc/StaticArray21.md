...
## Class StaticArray21<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray21<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray21<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray21(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray21(java.lang.Class<T> type, T... values)` |
    | `StaticArray21(java.util.List<T> values)` Deprecated. |
    | `StaticArray21(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray21
      ...
      ```
      @Deprecated
      public StaticArray21(java.util.List<T> values)
      ```
    ...
    - #### StaticArray21
      ...
      ```
      public StaticArray21(java.lang.Class<T> type,
