...
## Class StaticArray14<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray14<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray14<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray14(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray14(java.lang.Class<T> type, T... values)` |
    | `StaticArray14(java.util.List<T> values)` Deprecated. |
    | `StaticArray14(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray14
      ...
      ```
      @Deprecated
      public StaticArray14(java.util.List<T> values)
      ```
    ...
    - #### StaticArray14
      ...
      ```
      public StaticArray14(java.lang.Class<T> type,
