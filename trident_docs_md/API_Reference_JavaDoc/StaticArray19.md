...
## Class StaticArray19<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray19<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray19<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray19(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray19(java.lang.Class<T> type, T... values)` |
    | `StaticArray19(java.util.List<T> values)` Deprecated. |
    | `StaticArray19(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray19
      ...
      ```
      @Deprecated
      public StaticArray19(java.util.List<T> values)
      ```
    ...
    - #### StaticArray19
      ...
      ```
      public StaticArray19(java.lang.Class<T> type,
