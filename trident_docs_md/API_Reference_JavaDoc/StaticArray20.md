...
## Class StaticArray20<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray20<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray20<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray20(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray20(java.lang.Class<T> type, T... values)` |
    | `StaticArray20(java.util.List<T> values)` Deprecated. |
    | `StaticArray20(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray20
      ...
      ```
      @Deprecated
      public StaticArray20(java.util.List<T> values)
      ```
    ...
    - #### StaticArray20
      ...
      ```
      public StaticArray20(java.lang.Class<T> type,
