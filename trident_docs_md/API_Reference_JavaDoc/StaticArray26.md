...
## Class StaticArray26<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray26<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray26<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray26(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray26(java.lang.Class<T> type, T... values)` |
    | `StaticArray26(java.util.List<T> values)` Deprecated. |
    | `StaticArray26(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray26
      ...
      ```
      @Deprecated
      public StaticArray26(java.util.List<T> values)
      ```
    ...
    - #### StaticArray26
      ...
      ```
      public StaticArray26(java.lang.Class<T> type,
