...
## Class StaticArray29<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray29<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray29<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray29(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray29(java.lang.Class<T> type, T... values)` |
    | `StaticArray29(java.util.List<T> values)` Deprecated. |
    | `StaticArray29(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray29
      ...
      ```
      @Deprecated
      public StaticArray29(java.util.List<T> values)
      ```
    ...
    - #### StaticArray29
      ...
      ```
      public StaticArray29(java.lang.Class<T> type,
