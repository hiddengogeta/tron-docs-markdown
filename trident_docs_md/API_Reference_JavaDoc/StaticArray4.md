...
## Class StaticArray4<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray4<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray4<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray4(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray4(java.lang.Class<T> type, T... values)` |
    | `StaticArray4(java.util.List<T> values)` Deprecated. |
    | `StaticArray4(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray4
      ...
      ```
      @Deprecated
      public StaticArray4(java.util.List<T> values)
      ```
    ...
    - #### StaticArray4
      ...
      ```
      public StaticArray4(java.lang.Class<T> type,
