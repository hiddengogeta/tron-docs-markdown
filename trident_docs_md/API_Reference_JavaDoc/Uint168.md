...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `Uint168(java.math.BigInteger value)` |
    | `Uint168(long value)` |
  + ### Method Summary
...
* + ### Field Detail
    ...
    - #### DEFAULT
      ...
      ```
      public static final Uint168 DEFAULT
      ```
  + ### Constructor Detail
    ...
    - #### Uint168
      ...
      ```
      public Uint168(java.math.BigInteger value)
      ```
    - #### Uint168
