...
## Class StaticArray18<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray18<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray18<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray18(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray18(java.lang.Class<T> type, T... values)` |
    | `StaticArray18(java.util.List<T> values)` Deprecated. |
    | `StaticArray18(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray18
      ...
      ```
      @Deprecated
      public StaticArray18(java.util.List<T> values)
      ```
    ...
    - #### StaticArray18
      ...
      ```
      public StaticArray18(java.lang.Class<T> type,
