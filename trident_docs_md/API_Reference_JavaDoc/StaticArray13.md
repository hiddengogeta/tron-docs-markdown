...
## Class StaticArray13<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray13<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray13<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray13(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray13(java.lang.Class<T> type, T... values)` |
    | `StaticArray13(java.util.List<T> values)` Deprecated. |
    | `StaticArray13(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray13
      ...
      ```
      @Deprecated
      public StaticArray13(java.util.List<T> values)
      ```
    ...
    - #### StaticArray13
      ...
      ```
      public StaticArray13(java.lang.Class<T> type,
