...
## Class StaticArray5<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray5<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray5<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray5(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray5(java.lang.Class<T> type, T... values)` |
    | `StaticArray5(java.util.List<T> values)` Deprecated. |
    | `StaticArray5(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray5
      ...
      ```
      @Deprecated
      public StaticArray5(java.util.List<T> values)
      ```
    ...
    - #### StaticArray5
      ...
      ```
      public StaticArray5(java.lang.Class<T> type,
