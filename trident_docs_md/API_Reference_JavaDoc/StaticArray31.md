...
## Class StaticArray31<T extends [Type](../../../../../../org/tron/trident/abi/datatypes/Type.html "interface in org.tron.trident.abi.datatypes")>
...
* + [org.tron.trident.abi.datatypes.Array](../../../../../../org/tron/trident/abi/datatypes/Array.html "class in org.tron.trident.abi.datatypes")<T>
  + - [org.tron.trident.abi.datatypes.StaticArray](../../../../../../org/tron/trident/abi/datatypes/StaticArray.html "class in org.tron.trident.abi.datatypes")<T>
    - * org.tron.trident.abi.datatypes.generated.StaticArray31<T>
...
* All Implemented Interfaces:
  ...
  ```
  public class StaticArray31<T extends Type>
...
* + ### Field Summary
  ...
  + ### Constructor Summary
    ...
    | `StaticArray31(java.lang.Class<T> type, java.util.List<T> values)` |
    | `StaticArray31(java.lang.Class<T> type, T... values)` |
    | `StaticArray31(java.util.List<T> values)` Deprecated. |
    | `StaticArray31(T... values)` Deprecated. |
  + ### Method Summary
...
* + ### Constructor Detail
    ...
    - #### StaticArray31
      ...
      ```
      @Deprecated
      public StaticArray31(java.util.List<T> values)
      ```
    ...
    - #### StaticArray31
      ...
      ```
      public StaticArray31(java.lang.Class<T> type,
